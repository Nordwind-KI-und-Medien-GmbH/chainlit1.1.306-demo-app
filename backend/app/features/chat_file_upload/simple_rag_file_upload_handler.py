...
from ..chat.tool_agent_w_memory.simple_rag_tool_agent import setup_runnable
...
async def file_loader(message: cl.Message):
    ...
    for element in message.elements:
        ...
        for doc in split_docs:
            ...
            doc.metadata[file_rag_fields.FIELD_NAME_USER_ID] = simple_rag_cl_user_session.current_user.id  # type: ignore
