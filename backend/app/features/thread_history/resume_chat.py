...
async def on_chat_resume(thread: ThreadDict):
    ...
    """
    herbalista_cl_user_session.current_thread = thread["id"]
    herbalista_cl_user_session.chat_has_uploaded_files = any(step['name'] == 'file_loader' for step in thread["steps"]) # type: ignore
