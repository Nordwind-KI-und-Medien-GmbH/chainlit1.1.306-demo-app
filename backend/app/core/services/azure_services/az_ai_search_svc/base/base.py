...
class BaseSimpleRagAzureSearch(AzureSearch):
    def __init__(
        self,
        index_name: str,
        embeddings,
        azure_search_service_endpoint: str = simple_rag_config.AZURE_SEARCH_SERVICE_ENDPOINT,  # type: ignore
        azure_search_api_key: str = simple_rag_config.AZURE_SEARCH_API_KEY,
    ):
